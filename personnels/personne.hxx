...
#define _PERSONNE_HXX
    ...
    #pragma db index(Personne::"noms_prenoms_cni_i") unique members ( noms_ , prenoms_ , cni_ )
    #pragma db index(Personne::"noms_prenoms_adresse_i") unique members ( noms_ , prenoms_ , adresse_ )
