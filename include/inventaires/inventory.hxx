...
#define _INVENTORY_HXX
    ...
    #pragma db member(Inventory::date_ended_) null options("CHECK(date_ended > date_started)")
    ...
    #pragma db index(Inventory::"responsable_date_started_i") unique members ( responsable_ , date_started_)
