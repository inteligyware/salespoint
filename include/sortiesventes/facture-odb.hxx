...
#ifndef FACTURE_ODB_HXX
#define FACTURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::Facture >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::Facture >
  {
    public:
    typedef ::Facture object_type;
    typedef ::QSharedPointer< ::Facture > pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;

    static const bool polymorphic = true;

    typedef ::Relancable root_type;
    typedef ::Relancable base_type;
    ...
    typedef object_traits< ::Document >::id_type id_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::Facture, id_pgsql, A >:
    pointer_query_columns< ::Relancable, id_pgsql, typename A::base_traits >
  {
    // Relancable
    //
    typedef pointer_query_columns< ::Relancable, id_pgsql, typename A::base_traits > Relancable;
  ...
  template <typename A>
  const typename pointer_query_columns< ::Facture, id_pgsql, A >::id_type_
  pointer_query_columns< ::Facture, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::Facture, id_pgsql, A >::reference_type_
  pointer_query_columns< ::Facture, id_pgsql, A >::
  reference (A::table_name, "\"reference\"", 0);

  template <>
  class access::object_traits_impl< ::Facture, id_pgsql >:
    public access::object_traits< ::Facture >
  {
    public:
    ...
    struct reglements_traits
    {
      ...
      typedef ::odb::vector< ::QLazyWeakPointer< ::Reglement > > container_type;
      typedef
      ...
      typedef pgsql::container_statements< reglements_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::Facture, id_common >:
    public access::object_traits_impl< ::Facture, id_pgsql >
  {
  };
  ...
  struct alias_traits<
    ::Sortie,
    id_pgsql,
    access::object_traits_impl< ::Facture, id_pgsql >::sortie_tag>
  {
    static const char table_name[];
  };

  template <>
  struct query_columns_base< ::Facture, id_pgsql >
  {
    // sortie
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::Facture, id_pgsql, A >:
    query_columns_base< ::Facture, id_pgsql >,
    query_columns< ::Relancable, id_pgsql, typename A::base_traits >
  {
    // Relancable
    //
    typedef query_columns< ::Relancable, id_pgsql, typename A::base_traits > Relancable;
  ...
  template <typename A>
  const typename query_columns< ::Facture, id_pgsql, A >::id_type_
  query_columns< ::Facture, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::Facture, id_pgsql, A >::reference_type_
  query_columns< ::Facture, id_pgsql, A >::
  reference (A::table_name, "\"reference\"", 0);
}

#include "facture-odb.ixx"

#include <odb/post.hxx>

#endif // FACTURE_ODB_HXX
