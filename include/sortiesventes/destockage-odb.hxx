...
#ifndef DESTOCKAGE_ODB_HXX
#define DESTOCKAGE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::Destockage >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::Destockage >
  {
    public:
    typedef ::Destockage object_type;
    typedef ::QSharedPointer< ::Destockage > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::Destockage, id_pgsql, A >:
    pointer_query_columns< ::Sortie, id_pgsql, typename A::base_traits >
  {
    ...
    static const raison_type_ raison;
  ...
  template <typename A>
  const typename pointer_query_columns< ::Destockage, id_pgsql, A >::id_type_
  pointer_query_columns< ::Destockage, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::Destockage, id_pgsql, A >::raison_type_
  pointer_query_columns< ::Destockage, id_pgsql, A >::
  raison (A::table_name, "\"raison\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::Destockage, id_pgsql, A >::action_type_
  pointer_query_columns< ::Destockage, id_pgsql, A >::
  action (A::table_name, "\"action\"", 0);

  template <>
  class access::object_traits_impl< ::Destockage, id_pgsql >:
    public access::object_traits< ::Destockage >
  {
    public:
    ...
    struct image_type
    {
      ...
      // raison_
      //
      details::buffer raison_value;
      std::size_t raison_size;
      bool raison_null;

      // action_
      //
      details::buffer action_value;
  ...
  template <>
  class access::object_traits_impl< ::Destockage, id_common >:
    public access::object_traits_impl< ::Destockage, id_pgsql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::Destockage, id_pgsql, A >:
  ...
  template <typename A>
  const typename query_columns< ::Destockage, id_pgsql, A >::id_type_
  query_columns< ::Destockage, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::Destockage, id_pgsql, A >::raison_type_
  query_columns< ::Destockage, id_pgsql, A >::
  raison (A::table_name, "\"raison\"", 0);

  template <typename A>
  const typename query_columns< ::Destockage, id_pgsql, A >::action_type_
  query_columns< ::Destockage, id_pgsql, A >::
  action (A::table_name, "\"action\"", 0);
}

#include "destockage-odb.ixx"

#include <odb/post.hxx>

#endif // DESTOCKAGE_ODB_HXX
