...
#ifndef MEDICAMENT_ODB_HXX
#define MEDICAMENT_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::Medicament >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::Medicament >
  {
    public:
    typedef ::Medicament object_type;
    typedef ::QSharedPointer< ::Medicament > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::Medicament, id_pgsql, A >:
    pointer_query_columns< ::Produit, id_pgsql, typename A::base_traits >
  {
    ...
    static const CIP_type_ CIP;
  };

  template <typename A>
  const typename pointer_query_columns< ::Medicament, id_pgsql, A >::id_type_
  pointer_query_columns< ::Medicament, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::Medicament, id_pgsql, A >::CIP_type_
  pointer_query_columns< ::Medicament, id_pgsql, A >::
  CIP (A::table_name, "\"cip\"", 0);

  template <>
  class access::object_traits_impl< ::Medicament, id_pgsql >:
    public access::object_traits< ::Medicament >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::Medicament, id_common >:
    public access::object_traits_impl< ::Medicament, id_pgsql >
  {
  };
  ...
  //
  template <typename A>
  struct query_columns< ::Medicament, id_pgsql, A >:
  ...
  template <typename A>
  const typename query_columns< ::Medicament, id_pgsql, A >::id_type_
  query_columns< ::Medicament, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::Medicament, id_pgsql, A >::CIP_type_
  query_columns< ::Medicament, id_pgsql, A >::
  CIP (A::table_name, "\"cip\"", 0);
}

#include "medicament-odb.ixx"

#include <odb/post.hxx>

#endif // MEDICAMENT_ODB_HXX
