...
protected:
    ...
    QString image_path_;    
    quint64 prix_vente_;
    qreal prix_achat_moy_{0};
    float remise_{0};
    float qte_colise_{1};
    quint32 qte_gros_{0};
    quint32 qte_details_{0};
    bool active_ {true};
...
public:
    ...
    void setQteGros(quint32 qte);
    quint32 getQteGros() const;

    void setQteDetails(quint32 qte);
    quint32 getQteDetails() const;
