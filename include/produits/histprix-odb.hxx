...
#ifndef HISTPRIX_ODB_HXX
#define HISTPRIX_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::HistPrix >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::HistPrix >
  {
    public:
    typedef ::HistPrix object_type;
    typedef ::QSharedPointer< ::HistPrix > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::HistPrix, id_pgsql, A >
  {
    // id
    //
    typedef
    ...
    static const date_fin_type_ date_fin;
  ...
  template <typename A>
  const typename pointer_query_columns< ::HistPrix, id_pgsql, A >::id_type_
  pointer_query_columns< ::HistPrix, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::HistPrix, id_pgsql, A >::prix_vente_type_
  pointer_query_columns< ::HistPrix, id_pgsql, A >::
  prix_vente (A::table_name, "\"prix_vente\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::HistPrix, id_pgsql, A >::date_fin_type_
  pointer_query_columns< ::HistPrix, id_pgsql, A >::
  date_fin (A::table_name, "\"date_fin\"", 0);

  template <typename A>
  const typename pointer_query_columns< ::HistPrix, id_pgsql, A >::produit_type_
  pointer_query_columns< ::HistPrix, id_pgsql, A >::
  produit (A::table_name, "\"produit\"", 0);

  template <>
  class access::object_traits_impl< ::HistPrix, id_pgsql >:
    public access::object_traits< ::HistPrix >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::HistPrix, id_common >:
    public access::object_traits_impl< ::HistPrix, id_pgsql >
  {
  };
  ...
  struct alias_traits<
    ::Produit,
    id_pgsql,
    access::object_traits_impl< ::HistPrix, id_pgsql >::produit_tag>
  {
    static const char table_name[];
  };

  template <>
  struct query_columns_base< ::HistPrix, id_pgsql >
  {
    // produit
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::HistPrix, id_pgsql, A >:
    query_columns_base< ::HistPrix, id_pgsql >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::HistPrix, id_pgsql, A >::id_type_
  query_columns< ::HistPrix, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::HistPrix, id_pgsql, A >::prix_vente_type_
  query_columns< ::HistPrix, id_pgsql, A >::
  prix_vente (A::table_name, "\"prix_vente\"", 0);

  template <typename A>
  const typename query_columns< ::HistPrix, id_pgsql, A >::date_fin_type_
  query_columns< ::HistPrix, id_pgsql, A >::
  date_fin (A::table_name, "\"date_fin\"", 0);

  template <typename A>
  const typename query_columns< ::HistPrix, id_pgsql, A >::produit_type_
  query_columns< ::HistPrix, id_pgsql, A >::
  produit (A::table_name, "\"produit\"", 0);
}

#include "histprix-odb.ixx"

#include <odb/post.hxx>

#endif // HISTPRIX_ODB_HXX
