...
#ifndef RELANCABLE_ODB_HXX
#define RELANCABLE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::Relancable >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::Relancable >
  {
    public:
    typedef ::Relancable object_type;
    typedef ::QSharedPointer< ::Relancable > pointer_type;
    ...
    static const bool auto_id = object_traits< ::Document >::auto_id;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::Relancable, id_pgsql, A >:
    query_columns< ::Document, id_pgsql, A >
  {
    // Document
    //
    typedef query_columns< ::Document, id_pgsql, A > Document;
  ...
  template <typename A>
  const typename query_columns< ::Relancable, id_pgsql, A >::typeid__type_
  query_columns< ::Relancable, id_pgsql, A >::
  typeid_ (A::table_name, "\"typeid\"", 0);

  template <typename A>
  struct pointer_query_columns< ::Relancable, id_pgsql, A >:
    query_columns< ::Relancable, id_pgsql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::Relancable, id_pgsql >:
    public access::object_traits< ::Relancable >
  {
    public:
    ...
    typedef object_traits_impl< ::Document, id_pgsql >::id_image_type id_image_type;

    static map_type* map;
    static const abstract_info_type info;

    struct image_type: object_traits_impl< ::Document, id_pgsql >::image_type
    {
      // typeid_
      //
    ...
    struct relances_traits
    {
      ...
      typedef ::odb::vector< ::QLazyWeakPointer< ::Relance > > container_type;
      typedef
      ...
      typedef pgsql::container_statements< relances_traits > statements_type;
  ...
  template <>
  class access::object_traits_impl< ::Relancable, id_common >:
    public access::object_traits_impl< ::Relancable, id_pgsql >
  {
  };
...
#include "relancable-odb.ixx"

#include <odb/post.hxx>

#endif // RELANCABLE_ODB_HXX
